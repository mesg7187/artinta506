...
<body>
    ...
    <img src="img/Fondo2.jpg" width="460" height="345">
<div class="bg">
<!-- Links (sit on top) -->
<div class="w3-top">
...
<div class="panel">
  ...
  <form class="w3-container" method="post" action="quoter.php" target="_blank">
    ...
    <div class="w3-section">
      <label>En que Provincia vive?</label>
      <input class="w3-input w3-border w3-hover-border-black" style="width:100%;" name="Message" required>
    </div><!-- comment -->
    <div class="w3-section">
    <input type="checkbox" name="consentimiento" value="1">autorizo a este sitio a usar mi informacion para los propositos de esta cotizacion.
    <div>
    <div class="w3-section">
    <input type="checkbox" name="leido" value="1">He ledio los terminos y condiciones.
    <div>
